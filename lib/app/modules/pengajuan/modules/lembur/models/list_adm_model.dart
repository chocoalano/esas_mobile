...
// Fungsi untuk decode JSON menjadi ListAdmModel
List<ListAdmModel> listAdmModelFromJson(String str) => List<ListAdmModel>.from(
    json.decode(str).map((x) => ListAdmModel.fromJson(x)));

// Fungsi untuk encode ListAdmModel menjadi JSON
String listAdmModelToJson(List<ListAdmModel> data) =>
...
class ListAdmModel {
  ...
  // Factory method untuk deserialisasi JSON ke ListAdmModel
  factory ListAdmModel.fromJson(Map<String, dynamic> json) => ListAdmModel(
        id: json["id"],
        name: json["name"],
        nik: json["nik"],
        email: json["email"],
  ...
  // Method untuk serialisasi ListAdmModel ke JSON
