...
// Fungsi untuk decode JSON menjadi ListFatModel
List<ListFatModel> listFatModelFromJson(String str) => List<ListFatModel>.from(
    json.decode(str).map((x) => ListFatModel.fromJson(x)));

// Fungsi untuk encode ListFatModel menjadi JSON
String listFatModelToJson(List<ListFatModel> data) =>
...
class ListFatModel {
  ...
  // Factory method untuk deserialisasi JSON ke ListFatModel
  factory ListFatModel.fromJson(Map<String, dynamic> json) => ListFatModel(
        id: json["id"],
        name: json["name"],
        nik: json["nik"],
        email: json["email"],
  ...
  // Method untuk serialisasi ListFatModel ke JSON
