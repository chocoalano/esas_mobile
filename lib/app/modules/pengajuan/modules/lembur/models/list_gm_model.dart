...
// Fungsi untuk decode JSON menjadi ListGmModel
List<ListGmModel> listGmModelFromJson(String str) => List<ListGmModel>.from(
    json.decode(str).map((x) => ListGmModel.fromJson(x)));

// Fungsi untuk encode ListGmModel menjadi JSON
String listGmModelToJson(List<ListGmModel> data) =>
...
class ListGmModel {
  ...
  // Factory method untuk deserialisasi JSON ke ListGmModel
  factory ListGmModel.fromJson(Map<String, dynamic> json) => ListGmModel(
        id: json["id"],
        name: json["name"],
        nik: json["nik"],
        email: json["email"],
  ...
  // Method untuk serialisasi ListGmModel ke JSON
