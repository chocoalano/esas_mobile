...
// Fungsi untuk decode JSON menjadi ListLineModel
List<ListLineModel> listLineModelFromJson(String str) =>
    List<ListLineModel>.from(
        json.decode(str).map((x) => ListLineModel.fromJson(x)));

// Fungsi untuk encode ListLineModel menjadi JSON
String listLineModelToJson(List<ListLineModel> data) =>
...
class ListLineModel {
  ...
  // Factory method untuk deserialisasi JSON ke ListLineModel
  factory ListLineModel.fromJson(Map<String, dynamic> json) => ListLineModel(
        id: json["id"],
        name: json["name"],
        nik: json["nik"],
        email: json["email"],
  ...
  // Method untuk serialisasi ListLineModel ke JSON
