...
// Fungsi untuk decode JSON menjadi ListUserModel
List<ListUserModel> listUserModelFromJson(String str) =>
    List<ListUserModel>.from(
        json.decode(str).map((x) => ListUserModel.fromJson(x)));

// Fungsi untuk encode ListUserModel menjadi JSON
String listUserModelToJson(List<ListUserModel> data) =>
...
class ListUserModel {
  ...
  // Factory method untuk deserialisasi JSON ke ListUserModel
  ...
  // Method untuk serialisasi ListUserModel ke JSON
