...
// Fungsi untuk decode JSON menjadi ListHrdModel
List<ListHrdModel> listHrdModelFromJson(String str) => List<ListHrdModel>.from(
    json.decode(str).map((x) => ListHrdModel.fromJson(x)));

// Fungsi untuk encode ListHrdModel menjadi JSON
String listHrdModelToJson(List<ListHrdModel> data) =>
...
class ListHrdModel {
  ...
  // Factory method untuk deserialisasi JSON ke ListHrdModel
  factory ListHrdModel.fromJson(Map<String, dynamic> json) => ListHrdModel(
        id: json["id"],
        name: json["name"],
        nik: json["nik"],
        email: json["email"],
  ...
  // Method untuk serialisasi ListHrdModel ke JSON
